...
public class TR_TempTooHot extends AlarmBasedTrigger {

	private static final long INTERVAL = 30 * 1000;

	public TR_TempTooHot(Context context, String id, int version) {
	...
	public void declareParameters() {
		...
		addParameter(R.string.filter_temp_high, R.string.filter_temp_high, "FILTER", "NUMBER", true, null);
	}
