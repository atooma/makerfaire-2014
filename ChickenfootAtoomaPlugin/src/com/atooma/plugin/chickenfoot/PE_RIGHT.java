...
public class PE_RIGHT extends Performer {

	public PE_RIGHT(Context context, String id, int version) {
	...
	public ParameterBundle onInvoke(String ruleId, ParameterBundle parameters) throws RemoteException {
		...
		try {
			JSONObject json = new JSONObject("{\"type\": \"right\", \"duration\" : " + duration + "}");
	...
	public void defineUI() {
		setTitle(R.string.pe_right);
		setIcon(R.drawable.icon_right);
	}
